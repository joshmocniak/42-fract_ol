...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/29 15:30:55 by jmocniak          #+#    #+#             */
/*   Updated: 2018/07/15 02:33:02 by jmocniak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

void	init_struct_vars_m(t_t_args *t, t_fract_vars *f)
{
	f->w = WIN_WIDTH;
	f->h = WIN_HEIGHT;
	f->c = t->byte_offset;
...
void	init_x_vars_m(t_t_args *t, t_fract_vars *f)
{
	f->new_re = 0;
	f->new_im = 0;
