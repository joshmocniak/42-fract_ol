...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/15 01:30:16 by jmocniak          #+#    #+#             */
/*   Updated: 2018/07/15 02:32:08 by jmocniak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

void	init_struct_vars_b(t_t_args *t, t_fract_vars *f)
{
	f->w = WIN_WIDTH;
	f->h = WIN_HEIGHT;
	f->c = t->byte_offset;
...
void	init_x_vars_b(t_t_args *t, t_fract_vars *f)
{
	f->new_re = 0;
	f->new_im = 0;
